...
int main (int argc, char *argv[])
{
	...
	rstatus = pthread_create (&thread_idA, NULL, routineA, (void*)("Thread A"));
	rstatus = pthread_create (&thread_idB, NULL, routineB, (void*)("Thread B"));
	rstatus = pthread_create (&thread_idC, NULL, routineC, (void*)("Thread C"));
	
	//Finaliza Thread
	rstatus = pthread_join (thread_idA, &thread_res);
	rstatus = pthread_join (thread_idB, &thread_res);
	rstatus = pthread_join (thread_idC, &thread_res);
